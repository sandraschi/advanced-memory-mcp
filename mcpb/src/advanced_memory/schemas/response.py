...
from advanced_memory.schemas.base import ContentType, EntityType, Observation, Permalink, Relation
...
class RelationResponse(Relation, SQLAlchemyModel):
    ...
    to_id: Permalink | None = Field(  # pyright: ignore
        # use the permalink from the associated Entity
        # or the to_id value
        validation_alias=AliasChoices(
