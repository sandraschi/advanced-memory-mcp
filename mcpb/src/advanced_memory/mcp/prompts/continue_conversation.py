"""Session continuation prompts for Advanced Memory MCP server.
...
from advanced_memory.schemas.prompt import ContinueConversationRequest
...
async def continue_conversation(
    topic: Annotated[str | None, Field(description="Topic or keyword to search for")] = None,
    timeframe: Annotated[
        TimeFrame | None,
