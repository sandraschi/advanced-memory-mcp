...
def main(argv: list[str] | None = None) -> None:
    ...
    validate = subparsers.add_parser("validate", help="Validate a modular skill folder.")
    ...
    upgrade = subparsers.add_parser("upgrade", help="Upgrade a legacy skill to modular format.")
