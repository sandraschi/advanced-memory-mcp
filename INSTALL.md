...
4. Start the server:
   ...
   uv run python -m advanced_memory_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn advanced_memory_mcp.server:app --port 10732
   ```
...
5. Open `http://localhost:10732` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/advanced-memory-mcp/issues) |
