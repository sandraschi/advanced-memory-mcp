...
import { FolderPlus, Trash2, ExternalLink, ShieldAlert, Loader2, CheckCircle2, ChevronRight, Briefcase } from 'lucide-react'
        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Organize your knowledge bases and workspaces</p>
                    </div>
                </div>
            ...
            {isLoading ? (
                ...
                <div className="card p-8 text-center border-red-500/30 bg-red-500/5">
                    ...
                    <button onClick={fetchProjects} className="btn btn-outline btn-sm mt-6">Try Again</button>
                </div>
            ) : (
                            ...
                            <div className="p-6">
                                <div className="flex items-start justify-between mb-2">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        {project.is_default && (
                                            <span className="px-2 py-0.5 bg-accent/20 text-accent text-[10px] font-bold rounded uppercase tracking-wider">Active</span>
                                        )}
                                    </div>
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    ...
                                    >
                                        {project.is_default ? <CheckCircle2 className="h-4 w-4 mr-2" /> : <ExternalLink className="h-4 w-4 mr-2" />}
                            ...
                            {deleteConfirm === project.name && (
                                <div className="absolute inset-0 bg-background/95 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-200">
                                    ...
                                    <div className="flex space-x-3 w-full">
                                        <button
                                            onClick={() => { setDeleteConfirm(null); setDeleteConfirmedOnce(false); }}
