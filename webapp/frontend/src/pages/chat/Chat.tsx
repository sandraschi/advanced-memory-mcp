...
import { MessageSquare, Send, User, Bot, Loader2, Trash2, Sliders, Zap, Sparkles } from 'lucide-react'
                        ...
                        {personalities.map((p) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs transition-all ${personality === p.id
                ...
                {messages.map((msg, i) => (
                    ...
                    >
                        <div className={`flex max-w-[80%] space-x-3 ${msg.role === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                            <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center border ${msg.role === 'user' ? 'bg-accent/10 border-accent/20 text-accent' : 'bg-gold/10 border-gold/20 text-gold'
                                }`}>
