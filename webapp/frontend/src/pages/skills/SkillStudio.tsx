          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">
                Forge Agent Intelligence v1.3.0
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-8">
            {steps.map((s, i) => (
              <div key={s.id} className="flex items-center">
                <div
                  className={`flex flex-col items-center space-y-2 transition-opacity ${step >= s.id ? "opacity-100" : "opacity-30"}`}
                >
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 ${step > s.id ? "bg-amber-500 text-black border-amber-500" : step === s.id ? "border-amber-500 text-amber-500" : "border-white/20 text-white/20"}`}
                  >
                ...
                {i < steps.length - 1 && (
                  <div
                    className={`w-12 h-px mx-4 transition-colors ${step > s.id ? "bg-amber-500" : "bg-white/10"}`}
                  />
                )}
              </div>
            ))}
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Define the purpose and scope of the new skill. Our synthesis engine will use
                    your Zettelkasten as primary reference.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/2 border border-white/5 p-4 rounded-2xl hover:bg-white/5 transition-colors cursor-pointer group">
                      ...
                      <p className="text-[10px] text-muted-foreground leading-relaxed">
                        Synthesize from existing Zettelkasten and research nodes.
                      </p>
                    </div>
                    <div className="bg-white/2 border border-white/5 p-4 rounded-2xl border-amber-500/20 bg-amber-500/5 group">
                      ...
                      <p className="text-[10px] text-muted-foreground leading-relaxed">
                        Design specialized terminal and filesystem automation routines.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  {isGenerating ? (
                    <>
                      <div className="relative z-10 flex flex-col items-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-8 italic">
                          Traversing knowledge graph to build authoritative SKILL.md...
                        </p>
                        ...
                        <span className="mt-2 text-[10px] font-mono text-amber-500">
                          {progress}%
                        </span>
                      </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-8">
                        Generated 356 lines of structured expert instructions.
                      </p>
                      <button
                  ...
                  <div className="bg-green-500/10 border border-green-500/20 p-6 rounded-2xl flex items-start space-x-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] text-muted-foreground">
                        All instructions comply with the Thermodynamic Behavioral Standards defined
                        in GEMINI.md.
                      </p>
                    </div>
                  </div>
            ...
            {step === 3 && (
              <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Review the synthesized instruction block before committing to the local depot.
                  </p>
                </div>
                ...
                <div className="bg-black/60 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="p-8 font-mono text-xs text-muted-foreground space-y-4 max-h-96 overflow-y-auto scrollbar-thin">
                    ...
                    <p>
                      You are an expert in {skillName}. Your goal is to assist the user by providing
                      deep insights extracted from the Advanced Memory knowledge graph.
                    </p>
                    <p>## Core Logic</p>
                    ...
                    <p>
                      Always audit skill calls against the ClawHub malware index (AMOS detection
                      active).
                    </p>
                    <p className="text-amber-500/80 italic">{"</instruction_block>"}</p>
                  </div>
                ...
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground max-w-sm mx-auto">
                      The `{skillName}` intelligence node is now active in your global depot and
                      recognized by all IDE rules.
                    </p>
                  </div>
            ...
            <div className="sticky top-0 space-y-8">
              ...
              <div className="bg-amber-500/5 border border-amber-500/20 rounded-3xl p-8">
                <h4 className="text-xs font-bold text-amber-500 uppercase tracking-widest mb-4">
                  Pro Tip: Depot Mapping
                </h4>
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  Synthesized skills are automatically mapped to your IDE rules. If you see "Malware
                  Detected," the engine will isolate the skill in a sandbox and require manual
                  binary auditing.
                </p>
              </div>
            </div>
