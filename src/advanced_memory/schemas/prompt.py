...
from advanced_memory.schemas.memory import EntitySummary, ObservationSummary, RelationSummary
...
class PromptMetadata(BaseModel):
    ...
    query: str | None = Field(None, description="The original query or topic")
    timeframe: str | None = Field(None, description="The timeframe used for filtering")
