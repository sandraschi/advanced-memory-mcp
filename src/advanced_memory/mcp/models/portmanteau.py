...
AudioOperation = Annotated[
    AudioDictateOp | AudioSpeakOp | AudioListenOp | AudioWakeStartOp | AudioWakeStopOp | AudioWakeStatusOp | AudioWeatherOp | AudioTimerOp | AudioAlarmOp | AudioMusicOp,
...
class SkillsCreateOp(BaseOp):
    ...
    category: Annotated[str | None, Field(description="Optional category folder (e.g., 'developer', 'research')")] = None
...
SkillsOperation = Annotated[
    SkillsCreateOp | SkillsReadOp | SkillsUpdateOp | SkillsDeleteOp | SkillsListOp | SkillsActivateOp | SkillsDeactivateOp | SkillsActiveOp | SkillsLoadSectionOp | SkillsLoadResourceOp | SkillsDistillWikiOp | SkillsDistillArxivOp | SkillsDistillTextbookOp | SkillsDistillTextOp | SkillsDistillExpertOp | SkillsImportGithubOp,
    Field(discriminator="operation")
]
...
InboxOperation = Annotated[
    InboxStatusOp | InboxProcessOp | InboxWatchOp | InboxInfoOp,
    Field(discriminator="operation")
]
# --- NOTES DOMAIN ---
...
class KnowledgeBulkOp(BaseOp):
    ...
    bulk_operation: Annotated[Literal["tag_analytics", "consolidate_tags", "tag_maintenance", "bulk_update", "validate_content", "project_stats", "find_duplicates", "bulk_move", "bulk_delete"], Field(description="Specific bulk operation to perform")]
...
class KnowledgeAnalyzeOp(BaseOp):
    ...
    analysis_type: Annotated[Literal["analyze_quality", "suggest_relationships", "find_gaps", "cluster_content", "extract_insights"], Field(description="Type of LLM analysis to perform")]
    filters: Annotated[dict | None, Field(description="Context filters (e.g. {'note_id': '...'} or {'topics': [...]})")] = None
...
KnowledgeOperation = Annotated[
    KnowledgeSuggestTagsOp | KnowledgeSummarizeOp | KnowledgeEnhanceOp | KnowledgeQCOp | KnowledgeCanvasOp | KnowledgeBulkOp | KnowledgeAnalyzeOp,
    Field(discriminator="operation")
]
...
SearchOperation = Annotated[
    SearchQueryOp | SearchRagOp | SearchExternalOp,
    Field(discriminator="operation")
]
...
class SystemHelpOp(BaseModel):
    ...
    level: Annotated[Literal["basic", "intermediate", "expert"], Field(description="Detail level of the documentation")] = "intermediate"
...
SystemOperation = Annotated[
    SystemStatusOp | SystemHelpOp | SystemWorkflowOp | SystemExternalOp | SystemSyncOp,
    Field(discriminator="operation")
]
...
TyporaOperation = Annotated[
    TyporaOpenOp | TyporaSaveOp | TyporaInsertOp | TyporaGetContentOp | TyporaSetContentOp | TyporaCursorOp | TyporaAnalyzeOp | TyporaExportOp,
    Field(discriminator="operation")
]
...
class ZettelGenerateOp(BaseOp):
    ...
    quality: Annotated[Literal["quick", "standard", "comprehensive", "expert"], Field(description="Level of detail and rigor")] = "standard"
...
ZettelOperation = Annotated[
    ZettelGenerateOp | ZettelExpandOp | ZettelSuggestOp | ZettelConnectOp | ZettelAnalyzeOp | ZettelCustomizeOp | ZettelCollectOp,
    Field(discriminator="operation")
]
...
AutomationOperation = Annotated[
    AutomationWorkflowOp | AutomationBatchOp | AutomationStatusOp,
    Field(discriminator="operation")
]
