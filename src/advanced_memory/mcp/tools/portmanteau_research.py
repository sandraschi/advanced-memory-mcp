...
async def adn_research(
    ...
    try:
        if operation == "web_search":
            ...
            result = await adn_web_search(query, limit=limit or 10)
            ...
            result = await adn_arxiv_research(query, limit=limit or 10)
            ...
            result = await adn_github_research(query, language=language, limit=limit or 10)
