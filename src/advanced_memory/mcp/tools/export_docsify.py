...
def _create_enhanced_readme(site_title: str, site_description: str, analysis: dict[str, Any]) -> str:
    ...
    features.append("- \U0001f4d6 **Auto TOC** - Automatically generated table of contents for each page")
...
**Export location**: `{abs_path}`"""
        ...
        browser_msg = "Browser opened automatically" if browser_opened else "Please open browser manually"
