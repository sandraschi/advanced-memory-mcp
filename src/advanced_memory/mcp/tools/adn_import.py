...
async def _joplin_import(
    ...
    return await (load_joplin_vault.fn if hasattr(load_joplin_vault, "fn") else load_joplin_vault)(
        source_path,
        destination_folder,
        preserve_structure,
        convert_links,
...
async def _onenote_import(
    ...
    return await (load_onenote_html.fn if hasattr(load_onenote_html, "fn") else load_onenote_html)(
