...
from advanced_memory.mcp.prompts import continue_conversation
from advanced_memory.mcp.prompts import recent_activity
from advanced_memory.mcp.prompts import search
from advanced_memory.mcp.prompts import ai_assistant_guide
