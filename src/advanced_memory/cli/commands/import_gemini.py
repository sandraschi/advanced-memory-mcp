"""Import command for Google Gemini conversations."""
...
from advanced_memory.importers import GeminiImporter
...
def import_gemini(
    ...
    This command will:
    1. Read Gemini conversation exports (from browser extensions)
