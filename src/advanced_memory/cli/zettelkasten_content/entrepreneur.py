"""Entrepreneur Zettelkasten Templates - Business models, fundraising, and growth strategies."""

ENTREPRENEUR_TEMPLATES = {
    "business-models": [
        {
            "title": "Business Model Canvas",
            "folder": "business/models",
            "content": r"""# Business Model Canvas
...
graph TB
    subgraph Value
        VP[Value<br/>Propositions]
    end
    subgraph Infrastructure
        KA[Key<br/>Activities]
        KR[Key<br/>Resources]
        KP[Key<br/>Partners]
    end
    subgraph Customers
        CS[Customer<br/>Segments]
        CH[Channels]
        CR[Customer<br/>Relationships]
    end
    subgraph Finances
        RS[Revenue<br/>Streams]
        CT[Cost<br/>Structure]
    end
```
