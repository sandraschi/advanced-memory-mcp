...
from advanced_memory.file_utils import parse_frontmatter, remove_frontmatter, ParseError
from advanced_memory.markdown.plugins import observation_plugin, relation_plugin
...
class EntityParser:
    ...
    async def parse_file_content(self, absolute_path, file_content):
        ...
        try:
            ...
            metadata = {}
            content_without_frontmatter = file_content
